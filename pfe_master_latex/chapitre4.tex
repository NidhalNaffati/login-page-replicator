...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.85\textwidth}{\centering
        \vspace{2.5cm}
        Espace réservé pour la Figure~\ref{fig:terraform_plan}\\
        \textbf{Capture d'écran~: Sortie de \texttt{terraform plan}}
        \vspace{2.5cm}
    }}
    \caption{Sortie de \texttt{terraform plan} montrant les ressources à créer}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.85\textwidth}{\centering
        \vspace{2.5cm}
        Espace réservé pour la Figure~\ref{fig:gke_console}\\
        \textbf{Capture d'écran~: Cluster GKE Autopilot dans la console GCP}
        \vspace{2.5cm}
    }}
    \caption{Cluster GKE Autopilot provisionné via Terraform}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.85\textwidth}{\centering
        \vspace{3cm}
        Espace réservé pour la Figure~\ref{fig:pipeline_overview}\\
        \textbf{Capture d'écran~: Vue globale du pipeline GitHub Actions}\\[6pt]
        \footnotesize Montrant les jobs~: build-test $\to$ app-image-release $\to$\\
        update-k8s-tags $\to$ e2e-tests $\to$ zap-baseline
        \vspace{3cm}
    }}
    \caption{Vue globale du pipeline GitHub Actions}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.85\textwidth}{\centering
        \vspace{2.5cm}
        Espace réservé pour la Figure~\ref{fig:sonarcloud_dashboard}\\
        \textbf{Capture d'écran~: Dashboard SonarCloud du projet}\\[6pt]
        \footnotesize Montrant les security hotspots, la couverture, les code smells
        \vspace{2.5cm}
    }}
    \caption{Dashboard SonarCloud montrant les résultats d'analyse}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.85\textwidth}{\centering
        \vspace{2.5cm}
        Espace réservé pour la Figure~\ref{fig:trivy_scan_results}\\
        \textbf{Capture d'écran~: Résultats du scan Trivy image sur nginx:1.21}
        \vspace{2.5cm}
    }}
    \caption{Résultats du scan Trivy montrant les CVEs de l'image nginx:1.21}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.85\textwidth}{\centering
        \vspace{2.5cm}
        Espace réservé pour la Figure~\ref{fig:zap_report}\\
        \textbf{Capture d'écran~: Rapport OWASP ZAP (avant durcissement)}
        \vspace{2.5cm}
    }}
    \caption{Rapport OWASP ZAP montrant les findings avant durcissement nginx}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.85\textwidth}{\centering
        \vspace{2.5cm}
        Espace réservé pour la Figure~\ref{fig:argocd_dashboard}\\
        \textbf{Capture d'écran~: Dashboard Argo CD montrant l'application synchronisée}
        \vspace{2.5cm}
    }}
    \caption{Dashboard Argo CD montrant l'état synchronisé de l'application}
...
La couverture de code est supérieure à 80\% grâce au Quality Gate SonarCloud.
...
Tests & Unit tests Jenkins & Unit + E2E + 6 scénarios Playwright \\ \hdashline
...
Audit trail & Inexistant & Chaque commit/build/deploy tracé \\
\hline
\end{tabularx}
\end{table}
