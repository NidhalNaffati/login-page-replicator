...
\hline
Coverage tests unitaires & Non mesurée & 13\,\% (Vitest) \\
\hline
...
\textbf{Apports à l'entreprise~:} Le projet a livré à l'équipe QA de Sopra HR Software une
plateforme DevSecOps opérationnelle et documentée, un référentiel de bonnes pratiques pour
la conception de pipelines sécurisés, une démonstration concrète de l'intégration SAST/SCA/DAST
dans GitHub Actions, et des templates Terraform/Kubernetes réutilisables. Ces livrables sont
directement transposables aux projets réels de l'équipe qui utilisent le framework T4T,
permettant d'enrichir les pipelines BDD existants avec des couches de sécurité et des rapports
d'analyse automatisés.

\textbf{Apports pour l'élève-ingénieur~:} Ce stage au sein de l'équipe QA a permis d'acquérir
des compétences transversales rares combinant l'ingénierie de la qualité logicielle, le cloud
engineering, la sécurité applicative, l'orchestration Kubernetes et la conception de pipelines
CI/CD modernes. La double perspective QA et DevSecOps constitue un profil particulièrement
...
\hline
QA \& Testing & BDD (T4T, Gherkin), Vitest, Playwright E2E, rapports d'analyse \\
\hline
...
\hline
Méthode & Analyse de risque, architecture en couches, Scrum, documentation \\
\hline
\end{tabularx}
\end{table}
