...
Ingénieur QA / DevSecOps & Humain & Conçoit les pipelines, intègre les tests et les scans de sécurité, génère les rapports d'analyse \\ \hdashline
Pipeline CI/CD (GitHub Actions) & Système & Exécute automatiquement les builds, tests, scans et publications de rapports \\ \hdashline
...
BNF-07 & Couverture de tests unitaires mesurée et intégrée au Quality Gate SonarCloud & Qualité \\ \hdashline
...
\hline
Product Owner & Encadrant professionnel (Sopra HR Software) & Définition des priorités et validation des livrables \\ \hdashline
Scrum Master & Encadrant académique & Suivi méthodologique et levée des blocages \\ \hdashline
Développeur / QA Engineer & NAFFATI & Conception des pipelines, intégration sécurité, implémentation et tests \\
\hline
    \end{tabularx}
\end{table}
