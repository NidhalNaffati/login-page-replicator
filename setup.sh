...
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "  1. Access dashboards locally:"
echo -e "     ${GREEN}./port-forward-dashboards.sh${NC}"
echo ""
echo -e "  2. Get Wazuh password (SSH into VM):"
echo -e "     ${GREEN}gcloud compute ssh wazuh-manager --zone=${GCP_ZONE} --project=${GCP_PROJECT} \\${NC}"
echo -e "     ${GREEN}  --tunnel-through-iap --command='cat /etc/motd'${NC}"
echo ""
echo -e "  3. Push a commit to trigger CI/CD pipeline:"
echo -e "     ${GREEN}git push origin master${NC}"
echo ""
echo -e "  4. Set GitHub Actions secrets (from terraform dir):"
echo -e "     ${GREEN}cd terraform${NC}"
echo -e "     ${GREEN}gh secret set GCP_WORKLOAD_IDENTITY_PROVIDER --repo NidhalNaffati/login-page-replicator --body \"\$(terraform output -raw workload_identity_provider)\"${NC}"
echo -e "     ${GREEN}gh secret set GCP_SERVICE_ACCOUNT --repo NidhalNaffati/login-page-replicator --body \"\$(terraform output -raw github_actions_sa_email)\"${NC}"
echo ""
